...
class EmailSender:
    ...
    def mail_template(self, title, status_count = {}, rows = "", type = "general"):
        ...
        html_content += '                <h1 class="title">🔔 Tienes órdenes por atender — Actualiza su estado lo antes posible. </h1>'
        
        # UPD 2025-12-08 By CarlosB -- Setting subtitle
        if type == "inventory_trigger":
          html_content += '                <h3> Estas órdenes ONESTOP cuentan con stock en planta </h3>'
        elif type == "sim_control":
          html_content += '                <h3> Estas órdenes ONESTOP cuentan con stock en planta </h3>'
    ...
    def mail_template_sim(self, title, status_count = {}, rows = ""):
        # Renderizar la plantilla con el contexto proporcionado
        ...
        html_content += '            <tr>'
        html_content += '              <td class="section" style="padding-top:12px;">'
        html_content += '                <h1 class="title">🔔 Existen recargas de SIM por atender — Actualiza su estado lo antes posible. </h1>'
        ...
        html_content += '            <tr>'
        html_content += '              <td class="section" style="padding-top:12px;">'
        html_content += '                <p style="margin:0 0 16px 0;">Estas son los SIM que requieren recarga:</p>'
          
        html_content += '                <table class="report-table">'
        html_content += '                 <thead>'
        html_content += '                   <tr>'
        html_content += '                     <th>Teléfono</th>'
        html_content += '                     <th>Usuario</th>'
        html_content += '                     <th>Carrier</th>'
        html_content += '                     <th>Ultima Recarga</th>'
        html_content += '                     <th>Días desde Ultima recarga</th>'
        html_content += '                   </tr>'
        html_content += '                 </thead>'
        html_content += '                 <tbody>'
        html_content += f'                  {rows}'
